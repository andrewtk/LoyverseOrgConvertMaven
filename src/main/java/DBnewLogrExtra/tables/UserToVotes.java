...
public class UserToVotes extends TableImpl<UserToVotesRecord> {
    ...
    private static final long serialVersionUID = 715325785;

    /**
     * The reference instance of <code>DBnewLogrExtra.user_to_votes</code>
     */
    ...
    /**
     * The column <code>DBnewLogrExtra.user_to_votes.id</code>.
     */
    ...
    /**
     * Create a <code>DBnewLogrExtra.user_to_votes</code> table reference
     */
    public UserToVotes() {
    ...
    /**
     * Create an aliased <code>DBnewLogrExtra.user_to_votes</code> table reference
     */
