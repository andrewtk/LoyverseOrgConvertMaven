...
public class QaTagwords implements Serializable {

    private static final long serialVersionUID = 1621151157;
    ...
    public QaTagwords(QaTagwords value) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("QaTagwords (");
